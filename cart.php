                ...
                <form action="cart.php" method="post" enctype="multipart/form-data">
                            ...
                            <tbody>
                                ...
                                <?php 
                                   ...
                                   while($row_cart = mysqli_fetch_array($run_cart)){
                                     ...
                                     $pro_qty = empty($row_cart['qty']) ? 1 : $row_cart['qty'];
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#"
                                            onclick="if(confirm('Are you sure you want to delete this item from cart?')){document.location='cart.php?delete=<?php echo $pro_id; ?>'}">
                    ...
                    <div class="box-footer">
                        ...
                        <div class="pull-right">
                            ...
                            <button type="submit" name="update" value="Update Cart" class="btn btn-danger">

                                <i class="fa fa-refresh"></i> Update Cart

                            </button>

                            <a href="order_address.php" class="btn btn-success">
