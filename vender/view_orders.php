                ...
                <div class="table-responsive"><!-- table-responsive begin -->
                    <table class="table table-striped table-bordered table-hover"><!-- table table-striped table-bordered table-hover begin -->
                        ...
                        <tbody><!-- tbody begin -->
                            ...
                            <?php 
                                $vendor_session_email = $_SESSION['vendor_email'];

                                $get_vendor = "SELECT vendor_id FROM vendors WHERE vendor_email='$vendor_session_email'";
                                ...
                                $get_orders = "select * from pending_orders where product_id in (select product_id from products where vendor_id='$vendor_id')";
                            ...
                            <tr><!-- tr begin -->
                                ...
                                <td>
                                    <a href="index.php?view_delivery_address=<?php echo $c_id; ?>" class="btn btn-primary">
                                            SEE
                                    </a>
                                </td>
                            </tr><!-- tr finish -->
