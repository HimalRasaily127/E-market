                    ...
                    <table class="table table-striped table-bordered table-hover"><!-- table table-striped table-bordered table-hover begin -->
                        ...
                        <tbody><!-- tbody begin -->
                            ...
                            <tr><!-- tr begin -->
                                ...
                                <td> <img src="other_images/<?php echo $manufacturer_image; ?>" width="60" height="60" onclick="myFunction('other_images/<?php echo $manufacturer_image; ?>','<?php echo $manufacturer_title; ?>')" id="<?php echo $manufacturer_title; ?>"></td>
