    ...
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <ol class="breadcrumb"><!-- breadcrumb begin -->
            <li class="active"><!-- active begin -->
                ...
                <i class="fa fa-dashboard"></i> Dashboard / View Sells
        ...
        <div class="panel panel-default"><!-- panel panel-default begin -->
            <div class="panel-heading"><!-- panel-heading begin -->
               <h3 class="panel-title"><!-- panel-title begin -->
                   ...
                   <i class="fa fa-tags"></i>  View Sells
                    ...
                    <table class="table table-striped table-bordered table-hover"><!-- table table-striped table-bordered table-hover begin -->
                        ...
                        <tbody><!-- tbody begin -->
                            ...
                            <?php 
                                ...
                                $get_pro = "SELECT * FROM products WHERE vendor_id='$vendor_id' AND product_id IN (SELECT product_id FROM sells)";
                            ...
                            <tr><!-- tr begin -->
                                ...
                                <td>
                                    <?php 
                                        $get_sell = "select * from sells where product_id='$pro_id'";
                                        $run_sell = mysqli_query($con,$get_sell);
                                        $row_sell = mysqli_fetch_array($run_sell);
                                        $sell_price = $row_sell['sell_price'];
                                        echo $sell_price;
                                    ?>
                                </td>
                                <td> 
