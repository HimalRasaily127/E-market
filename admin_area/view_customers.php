                        ...
                        <tbody><!-- tbody begin -->
                            ...
                            <?php 
                                ...
                                while($row_c=mysqli_fetch_array($run_c)){
                                    ...
                                    $c_province = $row_c['customer_province'];
                                    
                                    $c_district = $row_c['customer_district'];
                                    
                                    $c_rural_municipality = $row_c['customer_Rural_municipality'];

                                    $c_word_no = $row_c['customer_word_no'];
                            ...
                            <tr><!-- tr begin -->
                                ...
                                <td> <?php echo $c_rural_municipality ?> </td>
                                <td> <?php echo $c_word_no ?> </td>
                                <td>
