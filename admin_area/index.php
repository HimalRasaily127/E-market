<?php 
    ...
    if(!isset($_SESSION['admin_email'])){
        ...
        $admin_job = $row_admin['admin_role'];
        ...
        $get_pending_orders = "select * from pending_orders where vendor_id='$vendor_id'";
        
        $run_pending_orders = mysqli_query($con,$get_pending_orders);
        
        $count_pending_orders = mysqli_num_rows($run_pending_orders);
        $get_venders = "select * from vendors";
        $run_venders = mysqli_query($con,$get_venders);
        $count_vendors = mysqli_num_rows($run_venders);
       ...
       <?php include("includes/sidebar.php"); ?>
        ...
        <div id="page-wrapper"><!-- #page-wrapper begin -->
            <div class="container-fluid"><!-- container-fluid begin -->
                ...
                } if(isset($_GET['view_vender'])){
                        
                        include("view_vender.php");
