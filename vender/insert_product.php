...
if(isset($_POST['submit'])){
    ...
    $insert_product = "INSERT INTO `products`(`product_id`, `p_cat_id`, `cat_id`, `manufacturer_id`, `vendor_id`, `date`, `product_title`, `product_img1`, `product_img2`, `product_img3`, `product_price`, `product_keywords`, `product_desc`) VALUES('$product_cat','$cat','$manufacturer_id', '$vendor_id',NOW(),'$product_title','$product_img1','$product_img2','$product_img3','$product_price','$product_keywords','$product_desc')";
    ...
    if($run_product){
        ...
        echo "<script>alert('Product has not been inserted sucessfully')</script>";
