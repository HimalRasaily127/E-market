...
<nav class="navbar navbar-inverse navbar-fixed-top"><!-- navbar navbar-inverse navbar-fixed-top begin -->
    ...
    <a href="index.php?dashboard" class="navbar-brand"> Karnali Online Shopping</a>
            ...
            <ul class="dropdown-menu"><!-- dropdown-menu begin -->
                ...
                <li><!-- li begin -->
                    <a href="index.php?view_customers"><!-- a href begin -->
                        ...
                        <span class="badge badge-danger"><?php echo $count_customers; ?></span>
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse"><!-- collapse navbar-collapse navbar-ex1-collapse begin -->
        <ul class="nav navbar-nav side-nav"><!-- nav navbar-nav side-nav begin -->
            ...
            <li><!-- li begin -->
                <a href="#" data-toggle="collapse" data-target="#vender"><!-- a href begin -->
                        
                        <i class="fa fa-fw fa-tag"></i> Vendors
                        <i class="fa fa-fw fa-caret-down"></i>
                        
                </a><!-- a href finish -->
                
                <ul id="vender" class="collapse"><!-- collapse begin -->
                    <li><!-- li begin -->
                        <a href="index.php?view_vender"> View venders </a>
                    </li><!-- li finish -->
                </ul><!-- collapse finish -->
            ...
            <li><!-- li begin -->
                ...
                <ul id="products" class="collapse"><!-- collapse begin -->
                    ...
                    <li><!-- li begin -->
                        <a href="index.php?add_sell"> Add Sells price </a>
                    </li><!-- li finish -->
                    <li><!-- li begin -->
                        <a href="index.php?view_sell"> View Sells price </a>
                    </li><!-- li finish -->
                </ul><!-- collapse finish -->
